 ...
 * @author RAUL
 */
public class frmVendedorAdministrador extends javax.swing.JFrame {

    /**
     * Creates new form frmVendedorAdministrador
     */
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(130, 260, 170, 50);
        ...
        jButton2.setBounds(130, 70, 170, 50);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/caipi 2.0.png"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(-20, -10, 450, 400);
  ...
  frmVentafinal x  = new frmVentafinal();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVendedorAdministrador().setVisible(true);
            }
        });
    }
