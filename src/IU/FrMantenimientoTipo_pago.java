...
public class FrMantenimientoTipo_pago extends javax.swing.JFrame {
    Tipo_pagoDAO tipoDAO;
    DefaultTableModel dtm;
    int idtipo;
    

    public FrMantenimientoTipo_pago() {
   ...
   if(this.txtBuscar.getText().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrMantenimientoTipo_pago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrMantenimientoTipo_pago().setVisible(true);
            }
        });
    }
